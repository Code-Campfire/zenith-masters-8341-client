		...
		<div className="grid-container">
			<form className="sign-up-form" onSubmit={handleSubmit}>
				<fieldset style={{ display: 'flex', flexDirection: 'column' }}>
					...
					<input type="password" id="matchingPassword" name="matchingPassword" className="login-input" placeholder="Matching password" onChange={e => dispatch({ passwordMatch: e.target.value })} />
				</fieldset>
